...
function App() {
  ...
  function handleEditorDidMount(editor, monaco) {  //function that is called when the Monaco Editor is mounted and ready
    ...
    const provider = new WebrtcProvider("test-room", doc, { signaling: ["wss://4.155.107.179:4444 "], debug: true});   // creates a webRTC provider that sends changes to other clients, define our Azure VM as our signalling server
    //Bind YJS to Monaco
